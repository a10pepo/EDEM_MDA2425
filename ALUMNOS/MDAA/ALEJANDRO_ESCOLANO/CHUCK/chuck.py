...
MONGO_HOST = "localhost"  # Dirección donde está corriendo el contenedor
...
db_conn = pg8000.native.Connection(
    ...
    password='Welcome01',  # Contraseña de PostgreSQL
    database='chuck',  # Aquí está el nombre correcto de la base de datos
