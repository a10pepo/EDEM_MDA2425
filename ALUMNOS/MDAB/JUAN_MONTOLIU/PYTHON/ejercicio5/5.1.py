...
pokemon_data_df = pd.read_csv("data/pokemon_data.csv",
                              dtype ={
                                  "Name": str,
                                  "Type 1": str,
                                  "Type 2": str,
...
# ITERAR TODOS Y MOSTRAR EL ÍNDICE Y NOMBRE DE CADA FILA
...
# La columna es la suma de HP + ATAQUE + DEFENSA + VELOCIDAD
# La columna se llama TOTAL
...
# FILTRAR TIPO "GRASS" Y "POISON" Y UN HP >= 70
...
chunks = pd.read_csv("data/pokemon_data.csv", chunksize= 5)
