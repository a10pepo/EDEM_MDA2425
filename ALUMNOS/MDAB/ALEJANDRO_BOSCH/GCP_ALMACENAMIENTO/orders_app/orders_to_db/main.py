...
#nuevo producer
    producer_backup = EventsManager('orders-events-backup')
    producer_backup.create_publisher()
    ...
    while True:
        ...
        #Aquí se envía el mensaje al nuevo topic
        message_backup = {
            "order_id": order_id,
        ...
        producer_backup.send_message(message_backup)
        num_orders_generated += 1
        time.sleep(random.randint(15, 40))
